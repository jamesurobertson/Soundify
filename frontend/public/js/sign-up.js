const form = document.querySelector(".sign-up-form"); //Check to see if refers to the sign-up.pug
...
form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        window.location.href = "/"; //change later when finished with browse/home webpage
